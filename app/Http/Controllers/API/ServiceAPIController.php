...
class ServiceAPIController extends AppBaseController
{
    ...
    public function store(CreateServiceAPIRequest $request)
    {
        ...
        return $this->sendResponse($services->toArray(), 'Услуга успешно сохранена.);
    }
    ...
    public function update($id, UpdateServiceAPIRequest $request)
    {
        ...
        return $this->sendResponse($service->toArray(), 'Услуга успешно обновлена.);
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Услуга успешно удалена.);
    }
}
