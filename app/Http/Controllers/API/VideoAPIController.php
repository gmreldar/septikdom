...
class VideoAPIController extends AppBaseController
{
    ...
    public function store(CreateVideoAPIRequest $request)
    {
        ...
        return $this->sendResponse($videos->toArray(), 'Видео успешно сохранено.);
    }
    ...
    public function update($id, UpdateVideoAPIRequest $request)
    {
        ...
        return $this->sendResponse($video->toArray(), 'Видео успешно обновлено.);
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Видео успешно удалено.);
    }
}
