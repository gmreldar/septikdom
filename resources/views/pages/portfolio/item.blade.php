		...
		<div class="wrapper">
			...
			<div class="portfolio-single-content">
                ...
                <div class="preparation">
                    ...
                    <div class="photos">
                        @for ($i = 0; $i < 4; $i++)
                            <a href="/img/portfolio/portfolio-single/photos/big/photo1.jpg" class="photo"
                               ...
                               data-caption="<p>1 Подготовка к монтажу станции канализации для частного дома Юнилос Астра 5 Миди. Построение опалубки, т.к присутствует высокий уровень грунтовых вод</p>">
                                <img class="lazy" data-src="/img/portfolio/portfolio-single/photos/photo1.jpg" alt="">
                            </a>
                        @endfor
                    </div>
                    <div class="photos">
                        @for ($i = 0; $i < 8; $i++)
                        <a href="/img/portfolio/portfolio-single/img1.jpg" class="photo"
                           data-fancybox="photos-2"
                           data-caption="<p>1 Подготовка к монтажу станции канализации для частного дома Юнилос Астра 5 Миди. Построение опалубки, т.к присутствует высокий уровень грунтовых вод</p>">
                            <img class="lazy" data-src="/img/portfolio/portfolio-single/img1.jpg" alt="">
                        </a>
                        @endfor
                    </div>
                    --}}
                    ...
                    <div class="work-stats">
						<div class="stats-box">
							<div class="author-and-date">
								<div class="date">
									<svg>
										<use xlink:href="/img/svgdefs.svg#icon-calendar" xmlns:xlink="http://www.w3.org/1999/xlink"></use>
									</svg>
							...
							<div class="work-views">
								<svg>
									<use xlink:href="/img/svgdefs.svg#icon-view" xmlns:xlink="http://www.w3.org/1999/xlink"></use>
								</svg>
