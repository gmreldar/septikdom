...
@media (min-width: 768px) {
                    ...
                    <div class="single-product-tabs">
                                                ...
                                                <div class="table-row without-help">
                                                    <div class="characteristic-name">
                                                        ...
                                                        <div class="characteristic-svg-box"
                                                             data-text="">
                                                            <svg>
                                                                <use xlink:href="/img/svgdefs.svg#icon-info"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"></use>
                                                            </svg>
                                                        </div>
                                                    </div>
                        ...
                        <div class="tab-content">
                            <div class="single-item-calc">
                                ...
                                <div class="calc-item">
                                    <div class="calc-title">Общая протяженность трубопровода (от кессона до дома)</div>
                                    <div class="calc-inputs">
                                        <div class="input-group">
                                            <input type="text" class="select-input select-input-hot select-input-second"
                                                   data-required="true" data-prefix='м.' id="pipeline_length"
                                                   required>
                                            <span class="bar"></span>
                                        ...
                                        <label class="radio-input hint-container">
                                            <div class="hint-right" id="station-drop-distance-hint">
                                                <svg class="close-hint">
                                                    <use xlink:href="/dist//img/svgdefs.svg#icon-cross"
                                                         xmlns:xlink="http://www.w3.org/1999/xlink"></use>
                                                </svg>
                                    ...
                                    <div class="review-form">
                                        ...
                                        <div class="submit-box">
                                            <button class="button-submit button-submit-review"
                                                    id='button-submit-comment' type="submit">Добавить
                                                отзыв
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <div class="pay-question-box">
                                                <div class="pay-question">
                                                    ...
                                                    <p>Доставка осуществляется в течение 1-3х рабочих дней после
                                                        оформления заказа, или в более поздние сроки по вашему желанию
                                                        (приобретенное у нас оборудование может бесплатно храниться на
                                                        нашем складе до 6-ти месяцев по договору ответственного
                                                ...
                                                <div class="pay-question">
                                                    ...
                                                    <p>Наступил гарантийный случай? Хотите оформить возврат или обмен?
                                                        ...
                                                        бракованного или вернем вам деньги.</p>
                                                </div>
                                            </div>
                                            <div class="pay-question-box">
                                                <div class="pay-question stretch">
                                                    ...
                                                    <p>Доставка товара в пределах 80 км от КАД осуществляется бесплатно
                                                        в течение 3-х рабочих дней с момента заказа.</p>
                                                    <p>Доставка товара дальше 80 км от КАД рассчитывается менеджером
                                                        после оформления заказа и осуществляется также в сроки не более
                                                        3-х рабочих дней с момента звонка менеджера.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="card-four-outer">
            <div class="card-four-wrapper">
                <div class="masters">
                    ...
                    <div class="master-img"><img class="lazy" data-src="/img/card/masters/master1.jpg" alt=""></div>
                    <div class="master-img"><img class="lazy" data-src="/img/card/masters/master2.jpg" alt=""></div>
                </div>
                <div class="instruments">
                    ...
                    <div class="instrument-img"><img class="lazy" data-src="/img/card/instruments/instrument1.jpg"
                                                     alt=""></div>
                    <div class="instrument-img"><img class="lazy" data-src="/img/card/instruments/instrument2.jpg"
                                                     alt=""></div>
                </div>
            </div>
        </div>
    ...
    <section id="card-five" style="background-image: url(/img/bg2.jpg);">
...
@section('script')
    ...
    <script>
        var pipeline_length = {{ $contact->pipeline_length }};
        {{--var pipeline_length10 = {{ $contact->pipeline_length10 }};--}}
        {{--var pipeline_length20 = {{ $contact->pipeline_length20 }};--}}
        var plyvun = {{ $product->plyvun }};
        var pesok = {{ $product->pesok }};
        var suglinok = {{ $product->suglinok }};
        var glina = {{ $product->glina }};
        var well_150 = {{ $contact->well_150 }};
        var well_200 = {{ $contact->well_200 }};
        var formwork = {{ $contact->formwork }};
        var cable = {{ $contact->cable }};
        var cable2 = {{ $contact->cable2 }};
        var hot_cable = {{ $contact->hot_cable }};
        ...
        $('.calc-button-box .calc-button').click(function () {
            ...
            $(".select-input-second").each(function () {
                secondInput += parseInt(($(this).val())) * pipeline_length;
            });

            valData = (radioData + secondInput).toLocaleString('ru');
