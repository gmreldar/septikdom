...
<!-- Pesok Field -->
<div class="form-group col-sm-6">
    {!! Form::label('pesok', 'Песок:') !!}
    {!! Form::number('pesok', null, ['class' => 'form-control', 'min' => '0']) !!}
</div>

<!-- Suglinok Field -->
<div class="form-group col-sm-6">
    {!! Form::label('suglinok', 'Суглинок:') !!}
    {!! Form::number('suglinok', null, ['class' => 'form-control', 'min' => '0']) !!}
</div>

<!-- Glina Field -->
<div class="form-group col-sm-6">
    {!! Form::label('glina', 'Глина:') !!}
    {!! Form::number('glina', null, ['class' => 'form-control', 'min' => '0']) !!}
</div>

<!-- Plyvun Field -->
<div class="form-group col-sm-6">
    {!! Form::label('plyvun', 'Плывун:') !!}
    {!! Form::number('plyvun', null, ['class' => 'form-control', 'min' => '0']) !!}
</div>
