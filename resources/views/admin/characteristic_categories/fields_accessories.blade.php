...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('text', null, ['class' => 'form-control', 'id' => 'text1']) !!}
</div>

<!-- Annotation Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('annotation', 'Аннотация:') !!}
    {!! Form::textarea('annotation', null, ['class' => 'form-control', 'id' => 'text2']) !!}
</div>

<!-- price_list_text Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('price_list_text', 'Текст в прайс листе:') !!}
    {!! Form::textarea('price_list_text', null, ['class' => 'form-control', 'id' => 'text3']) !!}
</div>
