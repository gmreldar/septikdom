(function ($, DataTable) {
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', 'Экспорт') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', 'Сброс');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function (dt) {
            return '<i class="fa fa-refresh"></i> ' + dt.i18n('buttons.reload', 'Перезагрузить');
        },
    ...
    DataTable.ext.buttons.create = {
        ...
        text: function (dt) {
            return '<i class="fa fa-plus"></i> ' + dt.i18n('buttons.create', 'Добавить');
        },
    ...
    if (typeof DataTable.ext.buttons.copyHtml5 !== 'undefined') {
        $.extend(DataTable.ext.buttons.copyHtml5, {
            text: function (dt) {
                return '<i class="fa fa-copy"></i> ' + dt.i18n('buttons.copy', 'Копировать');
            }
        });
    }
